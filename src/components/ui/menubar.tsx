...
>(({ className, ...props }, ref) => (
    <MenubarPrimitive.Root
        ref={ref}
        className={cn("flex h-9 items-center space-x-1 rounded-md bg-background p-1 shadow-sm", className)}
        {...props}
    />
))
...
>(({ className, ...props }, ref) => (
    <MenubarPrimitive.Trigger
        ref={ref}
        className={cn(
            "flex cursor-default select-none items-center rounded-sm px-3 py-1 text-sm font-medium outline-none focus:bg-accent focus:accent-foreground data-[state=open]:bg-accent data-[state=open]:accent-foreground",
            className
        )}
        {...props}
    />
...
>(({ className, inset, children, ...props }, ref) => (
    <MenubarPrimitive.SubTrigger
        ref={ref}
        className={cn(
            "flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-accent focus:accent-foreground data-[state=open]:bg-accent data-[state=open]:accent-foreground",
            inset && "pl-8",
            className
        )}
        {...props}
