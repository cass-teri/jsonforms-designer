...
export function Footer() {
    ...
    return (
        <div className="fixed h-8 bottom-0 left-0 right-0 bg-accent flex flex-row ">
            ...
            <div className="m-1 border border-border h-6 w-32 flex items-center justify-start overflow-hidden text-nowrap">{vim_mode_message}</div>
            <div className="m-1 border border-border h-6 w-32 flex items-center justify-start overflow-hidden text-nowrap">{theme_message}</div>
            <div className={`m-1 border border-border h-6 w-48 flex items-center justify-start overflow-hidden text-nowrap ${dirty_color}`}>
                {dirty_message}
            </div>
        </div>
    )
